...
<body class="body">
    ...
    <section class="home-section">
        <h2 class="page-title">User Account</h2>

        <div class="list--top">
            <input class="searchText" type="text" id="search" name="search" placeholder="Search">
            <a href="createNewAccount.php" class="btn-add"><i class="fa-solid fa-user-plus"></i><span>Add</span>
            </a>
        </div>
        <div class="table-section">
            <div class="table-part">
                ...
                <p class="table-column-header">User Type</p>
                <p class="table-column-header"></p>
