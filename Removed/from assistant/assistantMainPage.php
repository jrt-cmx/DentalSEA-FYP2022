...
<!--------------------- Head --------------------->
<?php include '../dentist/includes/head.php' ?>

<body class="body">
    <!--------------------- Header --------------------->
    <?php include "../dentist/includes/header.php"; ?>
    ...
    <section class="home-section">
        ...
        <div class="dashboard--grid--section">
            ...
            <div class="grid--parts welcome grid--col--span--4" id="grid--top">
                ...
                // $id = ;
                $sql = "SELECT fName, lName FROM dentalassistant WHERE loginID = '" . $_SESSION['username'] . "'";
    ...
    <!--------------------- Scripts --------------------->
    <script src="../javascript/assistant.js"></script>
    <?php include '../dentist/includes/scripts.php' ?>
</body>
